...
@section('main')
    <div class="main-content">
        <section class="section">
            ...
            <div class="card">
                <form action="{{ route('user.store.myItem')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header">
                        <h4 class="text-danger">Input Item</h4>
                    </div>
                    <div class="card-body">
                        <input type="hidden" name="user_id" value="{{ auth()->id() }}">
                        <div class="form-group">
                            <label>Nama Item</label>
                            <input type="text" id="nama_item" name="nama_item" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Image</label>
                        ...
                        <div class="form-group">
                            <label style="font-size: 14px;">Catatan Tambahan</label>
                            <div>
                                <textarea class="summernote" name="catatan_tambahan" required></textarea>
                            </div>
                        </div>
                        <div>
