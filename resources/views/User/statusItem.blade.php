                                ...
                                <tbody>
                                    @foreach ($items as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->status }}</td>
                                            <td>
                                                <button type="submit" class="btn btn-secondary btn-action" title="tambahkan status">
                                                    <a href="{{ route('user.add.status.item', 'id') }}"><i class="fas fa-pencil"></i></a></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
